...
| Setup and distribution | Pinned curl/PowerShell bootstrap with managed Docker/PostgreSQL implemented; shared-runtime connection upgrades and native Windows PATH repair verified; interactive clean-machine acceptance and native binaries remain open |
