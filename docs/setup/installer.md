...
Default runtime: `$XDG_DATA_HOME/integra-code-memory/releases/v0.1.0-alpha.15`,
or `$HOME/.local/share/integra-code-memory/releases/v0.1.0-alpha.15`. Override with
...
The runtime defaults to `%LOCALAPPDATA%\integra-code-memory\releases\v0.1.0-alpha.15`;
...
```powershell
Invoke-WebRequest -UseBasicParsing 'https://raw.githubusercontent.com/iOwsla/integra-codebase-memory/v0.1.0-alpha.15/bootstrap.ps1' -OutFile bootstrap.ps1
