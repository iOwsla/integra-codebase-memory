# v0.1.0-alpha.26 — Claude schema compatibility and code checkpoints
...
```sh
codememory update --version v0.1.0-alpha.26
```
...
[Changes since alpha.25](https://github.com/iOwsla/integra-codebase-memory/compare/v0.1.0-alpha.25...v0.1.0-alpha.26)
